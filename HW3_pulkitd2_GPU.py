...
train_dataset = torchvision.datasets.CIFAR10(root = repo, train=True, transform=transform_train, download=False)
test_dataset = torchvision.datasets.CIFAR10(root = repo, train=False, transform=transform_train, download=False)
